...
class BuildProxy:
    ...
    def BuildProxyForSelectedmesh(self):
        ...
        ctrlTopGroup = "ac_" +self.model + "_proxy_grp"
        mc.group(ctrls, n = ctrlTopGroup)

        globalProxyCtrl = "ac_" + self.model + "_proxy_gloabal"
        mc.circle(n=globalProxyCtrl, r = 20)
        mc.parent(proxyTopGrp, globalProxyCtrl)     
        mc.parent(ctrlTopGroup, globalProxyCtrl)   
